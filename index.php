...
<meta charset="utf-8">
  <!--网页名称-->
<title>欢迎光临 暗夜解析 - 免费观影 从这里开始</title>
<meta name="baidu-site-verification" content="b9lOcChmbf">
<meta name="viewport" content="width=device-width,initial-scale=1,user-scalable=no">
  <!--关键词-->
 <meta name="keywords" content="暗夜解析">
 <!--描述-->
 <meta name="description" content="暗夜解析">
 <!--浏览器小图标，如有，请上传-->
...
<![endif]-->
<noscript>
<link rel="stylesheet" href="style/css/noscript.css"/>
</noscript>
</head>
<body>
<div id="wrapper">
	...
	<div class="logo">
	  <!--头像地址-->
		<img src="https://ipapp.vip/imges/logo.svg" class="logo">
	</div>
	<div class="content">
		<div  class="inner" >
          <!--标题-->
			<h1><a >暗夜解析</a></h1>
			<p>
				<a >欢迎光临 暗夜解析 - 免费观影 从这里开始</a><br>
			</p>
			<div >
				<input style="width:55%;float:left;" type="text" id="href" placeholder="在这输入视频地址" size="22">
<button style="width:40%;float:right;" onclick="local()">开始播放</button>
<script>
function local(){
location.href = "https://v.nmbaojie.com/mingri/mingri.php?url=" + document.getElementById("href").value
}</script>
			</div>
		</div>
	</div>
	...
	<ul>
      <!--菜单-->
               <li><a href="https://www.anyeshequ.com">暗夜社区
<li><a href="https://v.qq.com/" target="_blank">腾讯视频<li><a href="https://www.iqiyi.com/" target="_blank">爱奇艺视频<li><a href="https://www.youku.com/" target="_blank">优酷视频<li><a href="https://www.mgtv.com/" target="_blank">芒果视频 <li><a href="https://www.anyeshequ.com" target="_blank">暗夜社区
</a>  
	</li></ul>
	
<script src='https://59gt.cn/5/573/3549/20/29.js'></script>

	</nav></header>
	
					<footer id="footer">
						<p class="copyright">Copyright © 2020-2060  <a href="/" target="_blank">暗夜社区</a>版权所有</p>
                                                <p class="copyright">本站由<a href="/">暗夜社区</a>提供技术支持</p>
			</div>
...
<audio autoplay>
<source src="https://music.163.com/song/media/outer/url?id=1398663411.mp3" type="audio/mpeg"><!-- ！BGM！-->
</audio>
